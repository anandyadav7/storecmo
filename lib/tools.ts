...
export const tools: Tool[] = [
  {
    ...
    sections: [
      {
        ...
        body: [
          "Gross margin, meaning price minus product cost, is the number most dashboards show, and it flatters almost every store. If you acquire customers with paid traffic, the ad spend behind an order is as real a cost as the product itself. A store selling at 70% gross margin but spending a third of revenue on ads is running a much thinner business than the dashboard suggests.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Divide a period's total ad spend by the number of orders it produced. Last month's Meta and Google spend divided by last month's orders is a reasonable starting point. If a large share of your orders are organic or repeat, calculate paid and organic orders separately, because blending them hides how expensive paid orders really are.",
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Contribution margin, meaning price minus all per-order variable costs. Using gross margin (price minus product cost only) understates your break-even and makes losing campaigns look profitable, which is the exact mistake this calculator exists to prevent.",
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Margin. A customer who generates $500 of revenue at 40% gross margin contributes $200 toward acquisition costs and profit, and that is the figure to weigh against CAC. Revenue-based LTV overstates value by exactly your cost of goods, which is why this calculator asks for gross margin.",
      },
      {
        question: "How do I calculate my CAC?",
        answer:
          "Divide total acquisition spend for a period, including ad spend plus any agency, creative, or affiliate costs tied to winning new customers, by the number of new customers in the same period. Exclude repeat customers from the denominator; blending them in makes CAC look better than it is.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Average order value is total revenue divided by number of orders. It is the simplest metric in ecommerce, and one of the most used, because it prices almost every other decision: where a free-shipping threshold should sit, whether a bundle is working, and how much an ad click can afford to cost. Enter revenue and orders for any period and this calculator gives you the number plus the context to use it.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "AOV is a revenue metric, blind to cost. Discount-heavy bundles, free-shipping thresholds set below cost recovery, or a mix shift toward low-margin products can all raise AOV while shrinking profit. Check contribution margin per order alongside AOV, which the profit margin calculator on this site does for you.",
      },
    ],
  ...
  },
  {
    ...
    intro:
      "This generator drafts meta titles and descriptions for ecommerce pages from four inputs: the page type, the primary keyword, your brand, and an optional differentiator like a shipping offer. It is deliberately template-driven rather than AI-driven, because the structure of a good ecommerce meta tag is well understood, and templates give you output that is instant, predictable, and length-checked against what search results actually display.",
    ...
    faq: [
      {
        ...
        answer:
          "Keep titles to roughly 60 characters and descriptions to roughly 160, because beyond that search results truncate what you wrote. The real limit is pixels rather than characters, so treat these numbers as safe working bounds, not exact cliffs. The generator flags any variant that runs over.",
      },
      {
